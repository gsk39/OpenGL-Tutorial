...
TexturePtr Texture::LoadFromFile(const char* filename)
{
	...
	// 本当にBMPファイルか？
	// Windows用BMPファイルの先頭2バイトは常に’B’と’M’
	...
	// BMPファイルの情報を取得
	// 今回は24bitム圧縮形式だけを読むため、
	// 情報ヘッダサイズや違う、bitcount != 24,compression != 0の場合は除外される
	...
	/*
	*読み込んだBMPは24bit形式なので、データ形式はGL_RGB8としています。
	*しかし、フォーマットをGL_BGRとしている
	*/
